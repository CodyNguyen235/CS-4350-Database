...
public class DoubleclickOrder
{
	...
	public static void main(String[] args)
	{
		try
		{
			DoubleclickOrder window = new DoubleclickOrder();
			window.open();
		} catch (Exception e)
		{
			e.printStackTrace();
	...
	protected void createContents()
	{
		...
		shell.setText("Double-Click to Order Item");
		...
		lblRemoveCompleted.setBounds(10, 20, 414, 125);
		lblRemoveCompleted.setText("Double-click an \nItem to Order it");
